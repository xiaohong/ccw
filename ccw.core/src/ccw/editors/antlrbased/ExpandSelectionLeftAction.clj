...
(defn- -init
  ...
  [[ClojureEditorMessages/ExpandSelectionLeftAction_label] (ref {:editor editor :selection-history selection-history})])  

(defn- -post-init
  [#^ccw.editors.antlrbased.ExpandSelectionLeftAction this editor #^SelectionHistory selection-history]
  (.setEnabled this true))

(defn- #^SelectionHistory selection-history [#^ccw.editors.antlrbased.ExpandSelectionLeftAction t] (-> t .state deref :selection-history))
